  ...
  return (
    ...
    <div className='w-screen h-[50vh] relative'>
      ...
      <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
        ...
        <h3>React Native / OpenWeather API / StyleSheet</h3>
      </div>
    </div>
    ...
    <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
      <div className='col-span-4'>
        ...
        <p className='capitalize flex items-center'>
          ...
          <p className='capitalize flex items-center'>
          <RiRadioButtonFill className='pr-1' />	I integrated async/await in this project to get OpenWeather API data and displayed accordingly.<br/>
          </p>
        ...
        <a
          href='https://github.com/Muhammad-Faran-Babar/ShazamWeather'
          target='_blank'
          rel='noreferrer'
        >
